...
class Theme:
    ...
    def _load(self, name):
        ...
        dnames.append(os.path.normpath(os.path.join(os.path.dirname(__file__),"..","..","data","themes",name)))
        dnames.append(os.path.normpath(os.path.join(os.path.dirname(__file__),"..","..","..","data","themes",name)))
        ...
        dnames.append(os.path.normpath(os.path.join(os.path.dirname(__file__),"..","..","..","..","share","pgu","themes",name)))
        dnames.append(os.path.normpath(os.path.join(os.path.dirname(__file__),"..","..","..","..","..","share","pgu","themes",name)))
        dnames.append(os.path.normpath(os.path.join(os.path.dirname(__file__),"..","..","share","pgu","themes",name)))
        for dname in dnames:
