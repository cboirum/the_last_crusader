...
class ApplyForce (Framework):
    ...
    def __init__(self):
        ...
        self.body = self.world.CreateDynamicBody(
                    ...
                    shapeFixture=b2FixtureDef(density=20.0),
                )
    ...
    def Keyboard(self, key):
        ...
        if key==Keys.K_w:
            f = self.body.GetWorldVector(localVector=(0.0, -100000.0))
        ...
        if key==Keys.K_s:
            ...
            #self.body.SetXForm(self.body.position, 1)
