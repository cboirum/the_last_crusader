...
def particleFill(circR,polygon,world):
    gridXY = getHexGrid2(circR*2,10,10)
    circles = MultiPolygon([Point(x,y).buffer(r,res) for x,y in gridXY])
    #return circles
    print "made circles"
...
"""
Need function that takes in polygon, identifies circle centers for contained and intersecting circles.
Adds circles to the physics world. 
"""
world = False
circR = .25
particleFill(circR,polygon,world)
